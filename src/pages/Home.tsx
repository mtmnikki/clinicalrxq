...
export default function Home() {
  ...
  const testimonials = [
    {
      quote:
        "ClinicalRxQ transformed our practice. We've dramatically improved patient outcomes and enhanced our clinical services.",
    ...
    {
      quote:
        'The team-based approach is genius. My technicians are now clinical partners, not just dispensing assistants.',
    ...
    {
      quote:
        'Finally, a program that teaches implementation, not just theory. The comprehensive protocols make real-world application seamless.',
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold mb-4">
              Proven{' '}
              <span className="bg-gradient-to-r from-cyan-500 to-cyan-600 bg-clip-text text-transparent">Results</span>
            </h2>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold mb-4">
              What Our{' '}
              <span className="bg-gradient-to-r from-blue-500 to-cyan-600 bg-clip-text text-transparent">Members Say</span>
            </h2>
            <p className="text-xl text-gray-600">Real pharmacists, real results, real transformation</p>
          </div>
                ...
                <CardContent className="p-8">
                  ...
                  <div>
                    <div className="font-semibold text-gray-900">
                      <SafeText value={testimonial.author} />
                    </div>
