 ...
 * Live Airtable only: search, filters, pagination, and grid/list views.
 * Removed mock data and hard-coded totals; uses live result length for pagination.
 */
...
/**
 * Resource item component (grid/list)
 */
        ...
        <CardContent className="p-4">
          <div className="flex items-start justify-between">
            <div className="flex-1">
              <div className="font-medium text-sm line-clamp-2">{resource.name}</div>
            </div>
            <Button
              variant="ghost"
              size="sm"
...
const ResourcesPage: React.FC = () => {
  ...
  // Derive current page items client-side (AirtableService returns full filtered set)
        ...
        <div className="mx-auto max-w-[1280px] px-4 py-4">
          <div className="flex items-center justify-between">
            <div>
              ...
              <div className="text-sm text-slate-600">Browse all clinical and general pharmacy resources</div>
            </div>
            <div className="flex items-center gap-2">
        ...
        <div className="flex-1">
          ...
          <div className="mb-4 flex items-center justify-between">
            <div className="text-sm text-gray-600">
              Showing {resources.length === 0 ? 0 : start + 1}-{Math.min(end, resources.length)} of {resources.length} resources
            </div>
            <div className="flex items-center gap-2">
              ...
              <select
                ...
                onChange={(e) => {
                  ...
                  handleFiltersChange({ ...filters, sortBy: sortBy as any, sortOrder: sortOrder as any })
                }}
              >
